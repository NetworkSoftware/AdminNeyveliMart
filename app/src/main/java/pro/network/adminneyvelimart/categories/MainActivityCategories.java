...
public class MainActivityCategories extends AppCompatActivity implements CategoriesClick {
    ...
    private pro.network.adminneyvelimart.categories.CategoriesAdapter mAdapter;
                ...
                try {
                    ...
                    if (success == 1) {
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                            ...
                            if (jsonObject.has("availCourier")) {
                                categories.setAvailCourier(jsonObject.getString("availCourier"));
                            } else {
